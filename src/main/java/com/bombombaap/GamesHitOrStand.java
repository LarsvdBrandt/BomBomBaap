...
public class GamesHitOrStand {
    ...
    public static String renderGamePage(String p1, String p2, String dealer, int correct, int wrong, String feedback) {
        ...
        return "<html><head><title>Hit or Stand</title>"
            ...
            + "<style>body{font-family:'Press Start 2P', monospace; text-align:center; background:#000; min-height:100vh; overflow-x:hidden; color:#ffd600; padding:32px 32px 48px 32px;}"
            + ".starbg{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:0;pointer-events:none;}"
            + ".arcade-frame{position:relative;z-index:1;max-width:800px;margin:72px auto 0 auto;padding:56px 28px 44px 28px;background:linear-gradient(135deg,#222 60%,#333 100%);border:8px solid #ffd600;border-radius:32px;box-shadow:0 0 60px #000, 0 0 0 12px #d32f2f, 0 0 0 24px #388e3c;}"
            ...
            + ".arcade-btns{display:flex;justify-content:center;align-items:center;gap:24px;margin-top:36px;}"
            ...
            + "<script>"
            + "/* Card visuals and action handling */"
            ...
            + "<div id='feedback' style='margin-bottom:20px;font-size:2em;color:#ffff66;line-height:1.4;'>" + feedback + "</div>"
